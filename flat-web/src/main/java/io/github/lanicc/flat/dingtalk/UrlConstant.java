...
public class UrlConstant {
     ...
     * 发送群助手消息 url
     */
    public static final String SCENEGROUP_MESSAGE_SEND_V2 = "https://oapi.dingtalk.com/topapi/im/chat/scencegroup/message/send_v2";

    /**
     * 场景群加人
     */
    public static final String SCENEGROUP_MEMBER_ADD = "https://oapi.dingtalk.com/topapi/im/chat/scenegroup/member/add";

    /**
     * 查询场景群信息
     */
    public static final String SCENEGROUP_INFO = "https://oapi.dingtalk.com/topapi/im/chat/scenegroup/get";
}
